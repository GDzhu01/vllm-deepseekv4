...
$PROFILE_CMD vllm serve /mnt/lustre/hf-models/svf-weight \
    "${ENGINE_ARGS[@]}"


# lm_eval --model local-completions \
#   --model_args "model=svf-model,base_url=http://0.0.0.0:8000/v1/completions,tokenized_requests=False,tokenizer_backend=None,num_concurrent=2048,timeout=5000,max_length=32768" \
#   --tasks gsm8k \
#   --num_fewshot 5 \
#   --log_samples \
